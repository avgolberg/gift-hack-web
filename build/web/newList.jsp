         ...
         <div class="account-pages"></div>
            ...
            <div class="wrapper-page">
                ...
                <div class="panel-heading"> 
                    <h3 class="text-center"> <strong class="text-custom">Add new list</strong> </h3>
                </div> 

           <div class="panel-body">
                <form class="form-horizontal m-t-20"  action="<%=request.getContextPath()%>/new-list" method="post">
